...
Authenticated staff open **Print review flyers** from the portal home page (it is also linked
from Settings → Website). The page supports one flyer at a time, all six flyers, and protected
PDF, SVG, and PNG downloads. Staff may preview, print, and download the approved files; replacing
assets remains source-controlled outside ordinary portal CRUD.
