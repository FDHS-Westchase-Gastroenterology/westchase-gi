-- Restore the prior request-lifecycle functions without changing stored rows.
-- Keep lifecycle scheduling disabled during rollback: the restored policy does
-- not protect future or unknown appointment times.
