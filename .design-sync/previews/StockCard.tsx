/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/card-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: CardDefault, CardSmall, CardContentEdgeToEdge, CardCustomSpacing, CardHeaderWithBorder, CardFooterWithBorder (+6 not shown) */
...
import { StockAvatar as Avatar, StockAvatarFallback as AvatarFallback, StockAvatarGroup as AvatarGroup, StockAvatarGroupCount as AvatarGroupCount, StockAvatarImage as AvatarImage } from "westchase-gi";
import { StockButton as Button } from "westchase-gi";
import { StockCard as Card, StockCardAction as CardAction, StockCardContent as CardContent, StockCardDescription as CardDescription, StockCardFooter as CardFooter, StockCardHeader as CardHeader, StockCardTitle as CardTitle } from "westchase-gi";
...
import { StockToggleGroup as ToggleGroup, StockToggleGroupItem as ToggleGroupItem } from "westchase-gi";
