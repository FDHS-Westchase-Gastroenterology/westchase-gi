/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/attachment-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: AttachmentFiles, AttachmentContentOnly, AttachmentStates, AttachmentImages, AttachmentImageStates, AttachmentSizes (+2 not shown) */
...
import { StockAttachment as Attachment, StockAttachmentAction as AttachmentAction, StockAttachmentActions as AttachmentActions, StockAttachmentContent as AttachmentContent, StockAttachmentDescription as AttachmentDescription, StockAttachmentGroup as AttachmentGroup, StockAttachmentMedia as AttachmentMedia, StockAttachmentTitle as AttachmentTitle, StockAttachmentTrigger as AttachmentTrigger } from "westchase-gi";
