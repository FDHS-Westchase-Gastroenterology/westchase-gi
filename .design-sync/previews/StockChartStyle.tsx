/* ChartStyle injects the per-series CSS custom properties (--color-<key>) that the bars and lines read. It renders no visible markup of its own; this card shows the colours it produces.
...
export function ColoursItInjects() {
  return (
