/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/drawer-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: DrawerDemo, DrawerSwipeHandleExample, DrawerPosition, DrawerCustomWidthAndHeight, DrawerScrollable, DrawerSnapPoints (+2 not shown) */

"use client"


import { StockButton as Button } from "westchase-gi";
import { StockDrawer as Drawer, StockDrawerClose as DrawerClose, StockDrawerContent as DrawerContent, StockDrawerDescription as DrawerDescription, StockDrawerFooter as DrawerFooter, StockDrawerHeader as DrawerHeader, StockDrawerTitle as DrawerTitle, StockDrawerTrigger as DrawerTrigger } from "westchase-gi";
