/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/button-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: ButtonVariantsAndSizes, ButtonIconRight, ButtonIconLeft, ButtonIconOnly, ButtonInvalidStates, ButtonExamples */

"use client"


import { StockButton as Button, stockButtonVariants as buttonVariants } from "westchase-gi";
