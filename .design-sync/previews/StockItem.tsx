/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/item-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: DefaultVariantItems, OutlineVariantItems, MutedVariantItems, DefaultVariantItemsSmall, OutlineVariantItemsSmall, MutedVariantItemsSmall (+18 not shown) */

import Image from "next/image"


import { StockButton as Button } from "westchase-gi";
import { StockItem as Item, StockItemActions as ItemActions, StockItemContent as ItemContent, StockItemDescription as ItemDescription, StockItemFooter as ItemFooter, StockItemGroup as ItemGroup, StockItemHeader as ItemHeader, StockItemMedia as ItemMedia, StockItemSeparator as ItemSeparator, StockItemTitle as ItemTitle } from "westchase-gi";
