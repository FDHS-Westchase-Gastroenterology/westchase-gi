/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/dropdown-menu-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: DropdownMenuBasic, DropdownMenuComplex, DropdownMenuSides, DropdownMenuWithIcons, DropdownMenuWithShortcuts, DropdownMenuWithSubmenu (+8 not shown) */
...
import { StockAvatar as Avatar, StockAvatarFallback as AvatarFallback, StockAvatarImage as AvatarImage } from "westchase-gi";
...
import { StockDropdownMenu as DropdownMenu, StockDropdownMenuCheckboxItem as DropdownMenuCheckboxItem, StockDropdownMenuContent as DropdownMenuContent, StockDropdownMenuGroup as DropdownMenuGroup, StockDropdownMenuItem as DropdownMenuItem, StockDropdownMenuLabel as DropdownMenuLabel, StockDropdownMenuPortal as DropdownMenuPortal, StockDropdownMenuRadioGroup as DropdownMenuRadioGroup, StockDropdownMenuRadioItem as DropdownMenuRadioItem, StockDropdownMenuSeparator as DropdownMenuSeparator, StockDropdownMenuShortcut as DropdownMenuShortcut, StockDropdownMenuSub as DropdownMenuSub, StockDropdownMenuSubContent as DropdownMenuSubContent, StockDropdownMenuSubTrigger as DropdownMenuSubTrigger, StockDropdownMenuTrigger as DropdownMenuTrigger } from "westchase-gi";
