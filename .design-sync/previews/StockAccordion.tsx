/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/accordion-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: AccordionBasic, AccordionMultiple, AccordionWithBorders, AccordionInCard, AccordionWithDisabled */

import { StockAccordion as Accordion, StockAccordionContent as AccordionContent, StockAccordionItem as AccordionItem, StockAccordionTrigger as AccordionTrigger } from "westchase-gi";
