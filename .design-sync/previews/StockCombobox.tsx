/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/combobox-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: ComboboxBasic, ComboboxDisabled, ComboboxSides, ComboboxInvalid, ComboboxWithClear, ComboboxAutoHighlight (+14 not shown) */
...
import { StockCard as Card, StockCardContent as CardContent, StockCardFooter as CardFooter } from "westchase-gi";
import { StockCombobox as Combobox, StockComboboxChip as ComboboxChip, StockComboboxChips as ComboboxChips, StockComboboxChipsInput as ComboboxChipsInput, StockComboboxCollection as ComboboxCollection, StockComboboxContent as ComboboxContent, StockComboboxEmpty as ComboboxEmpty, StockComboboxGroup as ComboboxGroup, StockComboboxInput as ComboboxInput, StockComboboxItem as ComboboxItem, StockComboboxLabel as ComboboxLabel, StockComboboxList as ComboboxList, StockComboboxSeparator as ComboboxSeparator, StockComboboxTrigger as ComboboxTrigger, StockComboboxValue as ComboboxValue, stockUseComboboxAnchor as useComboboxAnchor } from "westchase-gi";
...
import { StockField as Field, StockFieldDescription as FieldDescription, StockFieldError as FieldError, StockFieldGroup as FieldGroup, StockFieldLabel as FieldLabel } from "westchase-gi";
