/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/context-menu-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: ContextMenuBasic, ContextMenuWithIcons, ContextMenuWithSides, ContextMenuWithShortcuts, ContextMenuWithSubmenu, ContextMenuWithGroups (+5 not shown) */
...
import { StockContextMenu as ContextMenu, StockContextMenuCheckboxItem as ContextMenuCheckboxItem, StockContextMenuContent as ContextMenuContent, StockContextMenuGroup as ContextMenuGroup, StockContextMenuItem as ContextMenuItem, StockContextMenuLabel as ContextMenuLabel, StockContextMenuRadioGroup as ContextMenuRadioGroup, StockContextMenuRadioItem as ContextMenuRadioItem, StockContextMenuSeparator as ContextMenuSeparator, StockContextMenuShortcut as ContextMenuShortcut, StockContextMenuSub as ContextMenuSub, StockContextMenuSubContent as ContextMenuSubContent, StockContextMenuSubTrigger as ContextMenuSubTrigger, StockContextMenuTrigger as ContextMenuTrigger } from "westchase-gi";
