/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/toggle-group-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: ToggleGroupBasic, ToggleGroupOutline, ToggleGroupOutlineWithIcons, ToggleGroupSizes, ToggleGroupSpacing, ToggleGroupWithIcons (+9 not shown) */
