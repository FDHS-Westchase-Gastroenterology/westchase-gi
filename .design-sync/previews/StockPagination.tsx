/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/pagination-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: PaginationBasic, PaginationSimple, PaginationIconsOnly */

"use client"


import { StockField as Field, StockFieldLabel as FieldLabel } from "westchase-gi";
import { StockPagination as Pagination, StockPaginationContent as PaginationContent, StockPaginationEllipsis as PaginationEllipsis, StockPaginationItem as PaginationItem, StockPaginationLink as PaginationLink, StockPaginationNext as PaginationNext, StockPaginationPrevious as PaginationPrevious } from "westchase-gi";
