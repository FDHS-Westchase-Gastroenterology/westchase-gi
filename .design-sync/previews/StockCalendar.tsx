/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/calendar-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: CalendarSingle, CalendarMultiple, CalendarWeekNumbers, CalendarBookedDates, CalendarRange, CalendarRangeMultipleMonths (+8 not shown) */
...
import { StockCalendar as Calendar, StockCalendarDayButton as CalendarDayButton } from "westchase-gi";
...
import { StockPopover as Popover, StockPopoverContent as PopoverContent, StockPopoverTrigger as PopoverTrigger } from "westchase-gi";
