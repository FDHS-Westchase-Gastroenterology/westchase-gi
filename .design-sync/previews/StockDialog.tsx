/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/dialog-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: DialogWithForm, DialogScrollableContent, DialogWithStickyFooter, DialogNoCloseButton, DialogChatSettings */
...
import { StockDialog as Dialog, StockDialogClose as DialogClose, StockDialogContent as DialogContent, StockDialogDescription as DialogDescription, StockDialogFooter as DialogFooter, StockDialogHeader as DialogHeader, StockDialogTitle as DialogTitle, StockDialogTrigger as DialogTrigger } from "westchase-gi";
import { StockField as Field, StockFieldContent as FieldContent, StockFieldDescription as FieldDescription, StockFieldGroup as FieldGroup, StockFieldLabel as FieldLabel, StockFieldSeparator as FieldSeparator, StockFieldSet as FieldSet, StockFieldTitle as FieldTitle } from "westchase-gi";
import { StockInput as Input } from "westchase-gi";
import { StockInputGroup as InputGroup, StockInputGroupAddon as InputGroupAddon, StockInputGroupButton as InputGroupButton, StockInputGroupInput as InputGroupInput } from "westchase-gi";
...
import { StockSelect as Select, StockSelectContent as SelectContent, StockSelectGroup as SelectGroup, StockSelectItem as SelectItem, StockSelectSeparator as SelectSeparator, StockSelectTrigger as SelectTrigger, StockSelectValue as SelectValue } from "westchase-gi";
