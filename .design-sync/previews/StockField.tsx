/* Ported by .design-sync/ds/port-examples.mjs from
   src/components/stock/examples/field-example.tsx — the shadcn registry's own demo,
   vendored by `npm run ds:stock`. Imports are aliased onto the bundle's
   Stock* exports; the JSX is the registry's, unchanged.
   Cells: InputFields, TextareaFields, SelectFields, CheckboxFields, RadioFields, SwitchFields (+4 not shown) */
...
import { StockField as Field, StockFieldContent as FieldContent, StockFieldDescription as FieldDescription, StockFieldGroup as FieldGroup, StockFieldLabel as FieldLabel, StockFieldLegend as FieldLegend, StockFieldSet as FieldSet, StockFieldTitle as FieldTitle } from "westchase-gi";
