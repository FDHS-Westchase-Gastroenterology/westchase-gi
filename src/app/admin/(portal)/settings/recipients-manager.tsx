...
import { RecipientRowItem } from "./recipient-row";
import type { RecipientLabelDraft, RecipientRow } from "./recipient-row";

export type { RecipientRow } from "./recipient-row";
...
interface RecipientsState {
  ...
  readonly labelDraft: RecipientLabelDraft | null;
