  ...
  return (
    <section aria-labelledby="portal-error-heading">
      ...
      <div className="portal-empty-state" role="alert">
        ...
        <p>
          No appointment request was changed by this failed page load. If retrying
          does not work, open Appointments and confirm the live queue before
          continuing from paper or email.
        </p>
        <div>
