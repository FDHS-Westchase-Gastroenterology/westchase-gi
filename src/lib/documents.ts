...
export const documents: PracticeDocument[] = [
  ...
  {
    id: "record-release-to-wcgi",
    category: "new-patient",
    label: {
      en: "Medical Record Release to WCGI",
      es: "Autorización para enviar expedientes médicos a WCGI",
      vi: "Ủy quyền gửi hồ sơ bệnh án đến WCGI",
      ko: "WCGI로의 의무 기록 제공 동의서",
      ar: "تفويض إرسال السجلات الطبية إلى WCGI",
    },
    file: null,
  },
  {
    id: "record-release-from-wcgi",
    category: "new-patient",
    label: {
      en: "Medical Record Release from WCGI",
      es: "Autorización para solicitar expedientes médicos de WCGI",
      vi: "Ủy quyền yêu cầu hồ sơ bệnh án từ WCGI",
      ko: "WCGI로부터의 의무 기록 발급 동의서",
      ar: "تفويض طلب السجلات الطبية من WCGI",
    },
    file: null,
  },
  ...
  },
  {
    ...
    label: {
      ...
      vi: "Chuẩn bị EGD (nội soi đường tiêu hóa trên)",
      ko: "EGD(상부 위장관 내시경) 준비법",
      ar: "تحضير EGD (تنظير الجهاز الهضمي العلوي)",
    },
    file: null,
  },
  {
  ...
  },
  {
    ...
    label: {
      ...
      vi: "Chuẩn bị nghiên cứu Endocapsule",
      ko: "Endocapsule 검사 준비법",
      ar: "تحضير دراسة Endocapsule",
    },
    file: null,
  },
  {
    id: "prep-sigmoidoscopy",
    category: "procedure-prep",
    label: {
      en: "Sigmoidoscopy Prep",
      es: "Preparación para sigmoidoscopia",
      vi: "Chuẩn bị nội soi đại tràng sigma",
      ko: "에스결장 내시경 준비법",
      ar: "تحضير تنظير القولون السيني",
    },
    file: null,
  },
  {
    id: "prep-anti-reflux-diet",
    category: "procedure-prep",
    label: {
  ...
  {
    id: "info-constipation",
    category: "disease-info",
    label: { en: "Constipation", es: "Estreñimiento", vi: "Táo bón", ko: "변비", ar: "الإمساك" },
    file: null,
  },
  {
    id: "info-crohns-disease",
    category: "disease-info",
    label: {
      en: "Crohn's Disease",
  ...
  {
    id: "info-food-allergy",
    category: "disease-info",
    label: {
      en: "Food Allergy / Intolerance",
      es: "Alergia e intolerancia alimentaria",
      vi: "Dị ứng / không dung nạp thực phẩm",
      ko: "식품 알레르기/불내증",
      ar: "حساسية الطعام / عدم تحمل الطعام",
    },
    file: null,
  },
  {
  ...
  },
  {
    ...
    label: {
      ...
      ko: "위식도 역류",
      ar: "الارتجاع المعدي المريئي",
    },
    file: null,
  },
  {
    id: "info-hemochromatosis",
    category: "disease-info",
    label: {
      en: "Hemochromatosis",
      es: "Hemocromatosis",
  ...
  {
    id: "info-intestinal-gas",
    category: "disease-info",
    label: {
      en: "Intestinal Gas",
      es: "Gases intestinales",
      vi: "Đầy hơi đường ruột",
      ko: "장내 가스",
      ar: "غازات الأمعاء",
    },
    file: null,
  ...
  },
  {
    id: "info-ulcers",
    category: "disease-info",
    label: { en: "Ulcers", es: "Úlceras", vi: "Vết loét", ko: "궤양", ar: "القرح" },
    file: null,
  },
  {
    id: "info-ulcerative-colitis",
    category: "disease-info",
    label: {
